...
export const FeaturesCards = () => {
  return (
    <section className="bg-background py-12 max-w-7xl mx-auto">
      <div className="container">
        <div className='max-w-2xl mx-auto'>
        <h1 className='tracking-tigher text-5xl text-center font-semibold'>Automations at Ease for your contracts</h1>
        <div className=''>
        <p className='text-muted-foreground text-center mt-5 text-xl'>Streamline your contract processes with our innovative features. From custom templates to comprehensive management tools, Xcontour is designed to meet your needs.</p>
        </div>
        </div>

        <div className="flex flex-col gap-4 mt-16 sm:flex-row sm:flex-1">
          {features.map(({title, description}, index) => (
            <div className="border border-input px-5 py-10 text-center rounded-xl" key={index}>
              <div className='inline-flex h-14 w-14 dark:bg-slate-100 dark:text-slate-800 bg-slate-800 text-slate-100 justify-center border items-center rounded-lg'>
